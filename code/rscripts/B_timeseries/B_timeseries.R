...
## Outcomes Plot Path
outcomes_plot_path <- paste(github_repo_path,"/docs/figures/timeseries/src", sep="")


## Data Path
data_path <-  paste(github_repo_path, feature_path, sep="")
...
####  Deleting axis and leave only the ones for 
#data <- data[, !c('Timestamp', 'MagnX', 'MagnY', 'MagnZ', 'qW', 'qX', 'qY', 'qZ') , with=FALSE]
#       
#"AccX" , "AccY", "AccZ", "GyroX", "GyroY", "GyroZ", "sg0zmuvAccX", "sg0zmuvAccY", "sg0zmuvAccZ",
#"sg0zmuvGyroX", "sg0zmuvGyroY", "sg0zmuvGyroZ",
#"sg1AccX", "sg1AccY", "sg1AccZ",
#"sg1GyroX", "sg1GyroY", "sg1GyroZ", 
#"sg1zmuvAccX", "sg1zmuvAccY", "sg1zmuvAccZ", "sg1zmuvGyroX", "sg1zmuvGyroY", "sg1zmuvGyroZ", 
#"sg2AccX", "sg2AccY", "sg2AccZ", "sg2GyroX", "sg2GyroY", "sg2GyroZ",
#"sg2zmuvAccX", "sg2zmuvAccY", "sg2zmuvAccZ", 
#"sg2zmuvGyroX", "sg2zmuvGyroY", "sg2zmuvGyroZ"
