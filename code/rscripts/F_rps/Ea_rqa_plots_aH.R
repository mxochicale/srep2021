...
##VERSION 
version <- '00'
feature_plot_path <- '/docs/figures/rqa/src/H'
#feature_path <- '/docs/figures/rps/src'
dataset_path <- '/data/rqa'


## Outcomes Plot Path
outcomes_plot_path <- paste(github_repo_path, feature_plot_path, sep="")
...
W$Axis <- gsub('sg0zmuvGyroZ', 'sg0', W$Axis) 
W$Axis <- gsub('sg1zmuvGyroZ', 'sg1', W$Axis) 
W$Axis <- gsub('sg2zmuvGyroZ', 'sg2', W$Axis) 
...
##REC
tagfile <- 'rec_bp_'
filenameimage <- paste(tagfile, activityk, "_", sensork, ".png",sep="")
