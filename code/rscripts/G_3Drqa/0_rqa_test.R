...
#epsilons <- seq(0.5,2,0.1)


################################################################################
#for (epsilon_idx in (1:100000)[numberOfEpsilons]){
...
selectActivity <- 'HN'
Wk <-  Wk[ Activity %in% selectActivity ]


selectSensor <- 'HS01'
Wk <-  Wk[ Sensor %in% selectSensor ]
...
Wk <-  Wk[ Axis %in% selectAxis ]




##converting into a matrix to plot as a surface!
