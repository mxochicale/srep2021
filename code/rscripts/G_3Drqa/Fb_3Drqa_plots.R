...
##VERSION 
version <- '00'
feature_path <- '/docs/figures/rqa/src/3drqa'
data_path <- '/data/rqa'
#feature_plot_path <- '/rqa_plots/topologies'

## Outcomes Data Path
#outcomes_data_path <- paste(github_repo_path,tput', feature_path, '/v', version, sep="")
## Outcomes Plot Path
...
#rqa_path <- paste(outcomes_data_path, '/rqa', sep="")
