...
main_outcomes_path = '/tmp/phdtmpdata/outcomes'
...
if (pNN_k == 1){
fpNNtmp <-function(x) {list("p01")}
} else if (pNN_k == 2){
fpNNtmp <-function(x) {list("p02")}
} else if (pNN_k == 3){
fpNNtmp <-function(x) {list("p03")}
} else if (pNN_k == 4){
fpNNtmp <-function(x) {list("p04")}
} else if (pNN_k == 5){
fpNNtmp <-function(x) {list("p05")}
} else if (pNN_k == 6){
fpNNtmp <-function(x) {list("p06")}
} else if (pNN_k == 7){
fpNNtmp <-function(x) {list("p07")}
} else if (pNN_k == 8){
fpNNtmp <-function(x) {list("p08")}
} else if (pNN_k == 9){
fpNNtmp <-function(x) {list("p09")}
} else if (pNN_k == 10){
fpNNtmp <-function(x) {list("p10")}
} else if (pNN_k == 11){
fpNNtmp <-function(x) {list("p11")}
} else if (pNN_k == 12){
fpNNtmp <-function(x) {list("p12")}
} else if (pNN_k == 13){
fpNNtmp <-function(x) {list("p13")}
} else if (pNN_k == 14){
fpNNtmp <-function(x) {list("p14")}
} else if (pNN_k == 15){
fpNNtmp <-function(x) {list("p15")}
} else if (pNN_k == 16){
fpNNtmp <-function(x) {list("p16")}
} else if (pNN_k == 17){
fpNNtmp <-function(x) {list("p17")}
} else if (pNN_k == 18){
fpNNtmp <-function(x) {list("p18")}
} else if (pNN_k == 19){
fpNNtmp <-function(x) {list("p19")}
} else if (pNN_k == 20){
fpNNtmp <-function(x) {list("p20")}
} else if (pNN_k == 21){
fpNNtmp <-function(x) {list("p21")}
} else if (pNN_k == 22){
fpNNtmp <-function(x) {list("p22")}
}
...
################################################################################
####    Writing Data
write.table(dataTable, "TidiedInterpolatedData.datatable", row.name=FALSE)

message(' TidiedInterpolatedData.datatable ', 'has been created at '  )
