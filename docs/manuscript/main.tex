...
Then using metrics of RQA, we find out that the type of movements
and the level of smoothness affects those metrics. 
Our contribution for this work is that entropy values from RQA were 
well distributed and presenting variation in all the conditions for time series. 
This work have then the potential to enhance the development of 
better diagnostic tools for various applications rehabilitation, 
...
% metrics with different embedding parameters, 
